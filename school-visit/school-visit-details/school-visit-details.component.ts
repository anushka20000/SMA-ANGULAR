...
@Component({
  ...
  templateUrl: "./school-visit-details.component.html",
  styleUrls: ["./school-visit-details.component.scss"],
})
export class SchoolVisitDetailsComponent implements OnInit, OnDestroy {
...
// const files:any={}
  ...
  loadEngineers(event: any) {
    ...
    this.projectType = this.schoolList[0].project;
    this.type1 = 1;
      ...
      .subscribe(
        (data) => {
          if (data) {
            ...
            this.loadAssets(this.schoolData.id);
            this.addForm.get("status")!.setValue(1);
            this.addForm.get("service_engineer")!.setValue(this.schoolData.service_engineer_id);
            this.addForm.get("school_id")!.setValue(this.schoolData.id);
            this.addForm.get("support_type")!.setValue(1);
            this.addForm.get("visit_id")!.setValue(this.id);
